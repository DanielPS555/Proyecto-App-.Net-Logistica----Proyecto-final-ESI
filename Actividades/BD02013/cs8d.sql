merge into actualiza as dst
	...
	on dst.vehiculo1=src.vehiculo1 and dst.vehiculo2=src.vehiculo2
	and dst.informe1=src.informe1 and dst.informe2=src.informe2
	and dst.registro1=src.registro1 and dst.registro2=src.registro2
when not matched then insert
	...
	(src.vehiculo1, src.informe1, src.registro1,
	 ...
	 src.tipo)
when matched then update set dst.tipo=src.tipo;
