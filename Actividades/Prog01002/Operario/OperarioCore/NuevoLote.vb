...
Public Class NuevoLote
    Private padre As Controladores.NotificacionLote
    Private destinosPosibles As List(Of Controladores.Lugar)
    Private origen As Controladores.Lugar
    Public Sub New(padre As Controladores.NotificacionLote, lugar As Controladores.Lugar)
    ...
    End Sub
    Public Sub New(padre As Controladores.NotificacionLote)
        Me.padre = padre
    ...
    Public Sub New(padre As Controladores.NotificacionLote, oldlote As Controladores.Lote)
        Me.padre = padre
        Me.origen = Controladores.Fachada.getInstancia.TrabajaEnAcutual.Lugar
        ' Esta llamada es exigida por el diseñador.
        InitializeComponent()
