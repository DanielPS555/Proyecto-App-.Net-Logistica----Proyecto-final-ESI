...
Public Class LoginTransportista
    ...
    Private Sub pass_Enter(sender As Object, e As EventArgs) Handles pass.Enter
        If pass.Text = "Contraseña" Then
            ...
            If contraseñaVisible Then ' asignar diseño de acuerdo al estado de contraseñaVisible
                ver.Image = Global.Trasportista.My.Resources.ojo_no
                pass.PasswordChar = ""
            Else
                ver.Image = Global.Trasportista.My.Resources.ojo
                pass.PasswordChar = "*"
            End If
            ver.Enabled = True
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Dim config As New Trasportista.ConfiguracionRed(Me)
        config.ShowDialog()
